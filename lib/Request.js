...
/**
 * Sets the permissions on the request object
 * @param permissions list of scopes (= permissions). Example: ['read:profile', 'write:profile']
 * @returns {Request}
 */
Request.prototype.setRequestScopes = function(permissions) {
  this._requestScopes = permissions;
  return this;
};

Request.prototype.getRequestScopes = function() {
  return this._requestScopes || [];
};
